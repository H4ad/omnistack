...
import { AnalyticsClientToken, AnalyticsMqttClientToken, AnalyticsServiceNameToken } from './tokens';
...
export class AnalyticsMqttClientModule {
  static registerAsync(options: MQTTClientModuleOptions, customProviderToken: InjectionToken = AnalyticsClientToken): DynamicModule {
    return {
      module: AnalyticsMqttClientModule,
      imports: [
        ClientsModule.registerAsync([
          {
            name: AnalyticsMqttClientToken,
